...
class MainPage extends Component {
    ...
    async componentDidMount() {
        ...
        FCM.getInitialNotification().then(notif => {
            console.log('Notification in main page', notif);
            // this.setState({
            //     initNotif: notif
            // })
    ...
    scheduleLocalNotification() {
        FCM.scheduleLocalNotification({
            id: 'testnotif',
            fire_date: new Date().getTime() + 1,
            vibrate: 500,
            title: 'Hello',
            body: 'Test Scheduled Notification',
            sub_text: 'sub text',
            priority: "high",
            large_icon: require("../../assets/images/attachment.png"),
            show_in_foreground: true,
            picture: require("../../assets/images/attachment.png"),
            wake_screen: true,
            extra1: { a: 1 },
            extra2: 1
        });
